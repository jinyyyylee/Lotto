...
class ResultActivity : AppCompatActivity() {
    ...
    val lottoview1 : ImageView = findViewById(R.id.lottoview1)
    val lottoview2 : ImageView = findViewById(R.id.lottoview2)
    val lottoview3 : ImageView = findViewById(R.id.lottoview3)
    val lottoview4 : ImageView = findViewById(R.id.lottoview4)
    val lottoview5 : ImageView = findViewById(R.id.lottoview5)
    val lottoview6 : ImageView = findViewById(R.id.lottoview6)
    val resultbt1 : Button = findViewById(R.id.resultbt1)*/
