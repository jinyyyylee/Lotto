...
/*    var gorandom : CardView = findViewById(R.id.gorandom)
    var goconstellation : CardView = findViewById(R.id.goconstellation)
    var goname : CardView = findViewById(R.id.goname)*/
