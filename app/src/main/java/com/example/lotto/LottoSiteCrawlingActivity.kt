...
import kotlin.math.round
  ...
  class LottoSiteCrawlingActivity : AppCompatActivity() {
    ...
    /*  var sitebt : Button = findViewById(R.id.sitebt)
      var result_title : TextView = findViewById(R.id.result_title)
      var date : TextView = findViewById(R.id.date)
      var ballnum1 : TextView = findViewById(R.id.ballnum1)
      var ballnum2 : TextView = findViewById(R.id.ballnum2)
      var ballnum3 : TextView = findViewById(R.id.ballnum3)
      var ballnum4 : TextView = findViewById(R.id.ballnum4)
      var ballnum5 : TextView = findViewById(R.id.ballnum5)
      var ballnum6 : TextView = findViewById(R.id.ballnum6)
      var bonusnum : TextView = findViewById(R.id.bonusnum)
      var money1 : TextView = findViewById(R.id.money1)
      var money2 : TextView = findViewById(R.id.money2)
      var money3 : TextView = findViewById(R.id.money3)
      var money4 : TextView = findViewById(R.id.money4)
      var money5 : TextView = findViewById(R.id.money5)
      var person1 : TextView = findViewById(R.id.person1)
      var person2 : TextView = findViewById(R.id.person2)
      var person3: TextView = findViewById(R.id.person3)
      var person4 : TextView = findViewById(R.id.person4)
      var person5 : TextView = findViewById(R.id.person5)*/
